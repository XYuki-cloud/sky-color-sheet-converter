...
Sky Music Sheet Maker 只用于理解旧 SkyStudio / 画世界谱面格式和兼容行为，不是本项目的运行依赖。参考链接和许可证信息见根目录的 [`THIRD_PARTY_NOTICES.md`](../../THIRD_PARTY_NOTICES.md)。可执行文件、模型、音频和其他外部二进制不属于本项目源码。
